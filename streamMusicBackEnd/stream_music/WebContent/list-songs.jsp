									...
									<div id="content">
										...
										<table class="table table-bordered table-striped">
											...
											<c:forEach var="tempSong" items="${SONG_LIST}">
												...
												<!-- set up a link to HeapSort a song -->
												<c:url var="HeapSortLink" value="songControllerServlet">
													<c:param name="command" value="HEAP_SORT_ALBUMORDER"/>
													<c:param name="songId" value="${tempSong.id}"/>
												</c:url>												

												<c:url var="BSTinorderSortLink" value="songControllerServlet">
													<c:param name="command" value="BST_INORDER_SORT_GENRE"/>
													<c:param name="songId" value="${tempSong.id}"/>
												</c:url>												

												<c:url var="RBTinorderSortLink" value="songControllerServlet">
													<c:param name="command" value="RBT_INORDER_SORT_ARTIST"/>
													<c:param name="songId" value="${tempSong.id}"/>
												</c:url>												
												...
												<tr>
													...
													<td>
														<div class="row">														
															...
															<div class="col-small">																
																<button type="submit" class="btn btn-danger btn-sm"
																onclick=" window.location.href = '${HeapSortLink}'; ">HeapSort
																</button>
															</div>															

															<div class="col-small">																
																<button type="submit" class="btn btn-danger btn-sm"
																onclick=" window.location.href = '${BSTinorderSortLink}'; ">bstInorder
																</button>
															</div>															

															<div class="col-small">																
																<button type="submit" class="btn btn-danger btn-sm"
																onclick=" window.location.href = '${RBTinorderSortLink}'; ">rbtInorder
																</button>
															</div>															
