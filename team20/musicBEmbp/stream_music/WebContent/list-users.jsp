						...
						<div id="navBarComponent">
								<nav class="navBar">
											...
											<div class="group">
												...
												<div class="navItem">
													<button class="navItemLinkBtn" onclick="window.location.href = 'http://localhost:8080/stream_music/datastructure_user.jsp';">
														User DataStructure
													</button>
												</div>
												...
												<div class="navItem">
													...
													onclick="window.location.href = 'http://localhost:8080/stream_music/datastructure_song.jsp';">
														Song DataStructure
													</button>
												</div>
											</div>
